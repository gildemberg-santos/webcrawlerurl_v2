...
func TestGoogleShoppingEntry_ToString(t *testing.T) {
	...
	assert.Equal(t, "ID: 1, Title: Product 1, Description: Description product 1, Link: https://www.google.com/shopping/product/1, ImageLink: https://www.google.com/shopping/image/product/1.jpg, Price: 5.00, Availability: in stock", newString)
}
